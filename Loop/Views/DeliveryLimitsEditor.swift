...
struct DeliveryLimitsEditor: View {
    ...
    var maximumBasalRateCard: Card {
        Card {
            SettingDescription(text: Text("The app will never enact a temporary basal rate greater than your maximum basal rate setting.", comment: "Maximum bolus setting description"))
            ExpandableSetting(
                isEditing: Binding(
    ...
    var maximumBolusCard: Card {
        Card {
            SettingDescription(
                text: Text("The app will prevent the delivery of any bolus larger than your maximum bolus setting.", comment: "Maximum basal rate setting description"))
            ExpandableSetting(
                isEditing: Binding(
