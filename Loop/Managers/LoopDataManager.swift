...
extension LoopDataManager {
    ...
    func storeSettings() {
        ...
        let settings = StoredSettings(date: now(),
                                      ...
                                      preMealTargetRange: loopSettings.preMealTargetRange?.doubleRange(for: loopSettings.glucoseUnit),
                                      workoutTargetRange: loopSettings.legacyWorkoutTargetRange?.doubleRange(for: loopSettings.glucoseUnit),
