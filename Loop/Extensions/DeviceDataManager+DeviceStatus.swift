...
extension DeviceDataManager {
    ...
    func didTapOnCGMStatus(_ view: BaseHUDView? = nil) -> HUDTapAction? {
        ...
        {
            return .presentCGMViewController(cgmManagerUI.settingsViewController(for: unit, glucoseTintColor: .glucoseTintColor, guidanceColors: .default))
        } else {
            return .setupNewCGM
        }
    }
    ...
    func didTapOnPumpStatus(_ view: BaseHUDView? = nil) -> HUDTapAction? {
            ...
            let action = pumpManagerHUDProvider.didTapOnHUDView(view)
        {
            ...
            return .presentPumpViewController(pumpManager.settingsViewController(insulinTintColor: .insulinTintColor, guidanceColors: .default))
        } else {
            return .setupNewPump
        }
    }
