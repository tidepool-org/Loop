...
#export BUILT_PRODUCTS_DIR=/Users/pete/Library/Developer/Xcode/DerivedData/Loop-gqwyxtsjfgxofmelczgcwptvkcsn/Build/Products/Debug-iphoneos
#export PLUGINS_FOLDER_PATH=Loop.app/PlugIns
#export EXPANDED_CODE_SIGN_IDENTITY=asdf
